...
hi DiffDelete      guifg=#d70087 guibg=#000000
hi DiffText                      guibg=#000000 gui=bold

hi Directory       guifg=#87ff00               gui=bold
hi Error           guifg=#ffafff guibg=#000000
...
hi Ignore          guifg=#808080 guibg=#000000
...
hi Search          guifg=#d70000 guibg=#000000

" marks column
hi SignColumn      guifg=#87ff00 guibg=#262626
hi SpecialChar     guifg=#d7005f               gui=bold
hi SpecialComment  guifg=#8a8a8a               gui=bold
hi Special         guifg=#5fd7ff guibg=#000000
hi SpecialKey      guifg=#8a8a8a

hi SpellBad        guifg=#ff0000 guibg=#000000  gui=bold
hi SpellCap        guifg=#ff0000 guibg=#000000  gui=bold
hi SpellRare       guifg=#ff0000 guibg=#000000  gui=bold
...
hi Todo            guifg=#d70000 guibg=#000000 gui=bold
...
hi TabLine         guifg=#878700 guibg=#000000
